				  ...
				  COLORREF clrBP, COLORREF clrBB)
{
	...
	{
		case WHITE_PAWN :
			BDRAW_PawnW1(hdc, clrWP, clrWB) ;
			return ;
		case BLACK_PAWN :
			BDRAW_PawnB1(hdc, clrBP, clrBB) ;
			return ;
		case WHITE_KNIGHT :
			BDRAW_KnightW1(hdc, clrWP, clrWB) ;
			return ;
		case BLACK_KNIGHT :
			BDRAW_KnightB1(hdc, clrBP, clrBB) ;
			return ;
		case WHITE_BISHOP :
			BDRAW_BishopW1(hdc, clrWP, clrWB) ;
			return ;
		case BLACK_BISHOP :
			BDRAW_BishopB1(hdc, clrBP, clrBB) ;
			return ;
		case WHITE_ROOK :
			BDRAW_RookW1(hdc, clrWP, clrWB) ;
			return ;
		case BLACK_ROOK :
			BDRAW_RookB1(hdc, clrBP, clrBB) ;
			return ;
		case WHITE_QUEEN :
			BDRAW_QueenW1(hdc, clrWP, clrWB) ;
			return ;
		case BLACK_QUEEN :
			BDRAW_QueenB1(hdc, clrBP, clrBB) ;
			return ;
		case WHITE_KING :
			BDRAW_KingW1(hdc, clrWP, clrWB) ;
			return ;
		case BLACK_KING :
			BDRAW_KingB1(hdc, clrBP, clrBB) ;
			return ;
	}
}
